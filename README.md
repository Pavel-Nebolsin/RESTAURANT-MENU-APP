...
### Дополнительно №2:
`P.S. Истории коммитов с первой недели нет, т.к. я что-то напутал, и после этого гит не хотел комитить, мёрджить, выдавая ошибки, и поэтому я решил просто перезалить проект заново.`
